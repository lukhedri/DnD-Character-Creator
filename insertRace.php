...
if (!filter_has_var(INPUT_POST, 'name') ||
    ...
    echo "There were problems retrieving race details. New book cannot be added.";
...
$sql = "INSERT INTO race "
        . "VALUES ('$newRace','$newVariant','$newStr','$newDex','$newCon','$newInt','$newWis','$newCha','$newChoose','$newFeature','$newDarkVision','$newSize', '1')";


//make sure it ran succesfull, if so tell the user or give user the error
if ($conn->query($sql) === TRUE) {
    echo "<p class = 'textCenter'>New Race was created successfully</p>";
} else {
